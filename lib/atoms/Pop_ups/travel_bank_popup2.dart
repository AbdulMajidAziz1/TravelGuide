...
class TravelBankPopup2 extends StatefulWidget {
  const TravelBankPopup2({super.key});

  @override
  State<TravelBankPopup2> createState() => _TravelBankPopup2State();
}

class _TravelBankPopup2State extends State<TravelBankPopup2> {
  @override
