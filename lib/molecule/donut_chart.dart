...
class DonutChartPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    for (var di in dataSet) {
      final currentValue = di.value - 0.08;
      final sweepAnglePaint = currentValue * fullAngle * pi / 180;
      final sweepAngleTotal = di.value * fullAngle * pi / 180;

      drawSectors(di, canvas, rect, startAngle, sweepAnglePaint);
